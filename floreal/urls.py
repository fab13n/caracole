...
urlpatterns = patterns('',
    ...
    url(r'^delivery-state/dv-(?P<delivery>[^/]+)/(?P<state>[A-Za-z]+)$',
    ...
    url(r'^edit-purchases/sg-(?P<subgroup>[^/]+)/dv-(?P<delivery>[^/]+)$',
    ...
    url(r'^validate-candidacy/cd-(?P<candidacy>[^/]+)/(?P<response>[YN])$',
        views.validate_candidacy, name='validate_candidacy'),
    ...
    url(r'^view/dv-(?P<delivery>[^/]+).html$', views.view_purchases_html, name='view_all_purchases_html'),
    url(r'^view/sg-(?P<subgroup>[^/]+)/dv-(?P<delivery>[^/]+).html$',
        views.view_purchases_html, name='view_subgroup_purchases_html'),
    url(r'^view/sg-(?P<subgroup>[^/]+)/dv-(?P<delivery>[^/]+).xlsx$',
        views.view_purchases_xlsx, name='view_subgroup_purchases_xlsx'),
    url(r'^view/sg-(?P<subgroup>[^/]+)/dv-(?P<delivery>[^/]+)/table.pdf$',
