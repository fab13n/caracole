...
urlpatterns = patterns('',
    ...
    url(r'^nw-(?P<network>[^./]+)/new-dv$', views.create_delivery, name='create_delivery'),
    url(r'^nw-(?P<network>[^./]+)/(?P<name>.+)/new-sg$', views.create_subgroup, name='create_subgroup'),
    url(r'^nw-(?P<network>[^./]+)/users$', views.edit_user_memberships, name='edit_user_memberships'),
    url(r'^nw-(?P<network>[^./]+)/users.json$', views.json_memberships, name='json_memberships'),

    url(r'^dv-(?P<delivery>[^./]+)$', views.edit_user_purchases, name='edit_user_purchases'),
    url(r'^dv-(?P<delivery>[^./]+)/admin$', views.edit_delivery, name='edit_delivery'),
    url(r'^dv-(?P<delivery>[^./]+)/products$', views.edit_delivery_products, name='edit_delivery_products'),
    url(r'^dv-(?P<delivery>[^./]+)/state/(?P<state>[^./]+)$', views.set_delivery_state, name='set_delivery_state'),
    url(r'^dv-(?P<delivery>[^./]+)/sg-(?P<subgroup>[^./]+)/state/(?P<state>[^./]+)$',
    ...
    url(r'^sg-(?P<subgroup>[^./]+)/new-cd$', views.create_candidacy, name='create_candidacy'),
    url(r'^cd-(?P<candidacy>[^./]+)/cancel$', views.cancel_candidacy, name='cancel_candidacy'),
    url(r'^cd-(?P<candidacy>[^./]+)/response/(?P<response>[YN])$', views.validate_candidacy, name='validate_candidacy'),
